...
class CollageViewT505: CollageView {
    ...
    private func initCells() {
        ...
        let lc11 = NSLayoutConstraint(item: cell03, attribute: .right, relatedBy: .equal, toItem: self, attribute: .right, multiplier: 1/2, constant:0)
        ...
        let lc012 = NSLayoutConstraint(item: cell05, attribute: .left, relatedBy: .equal, toItem: cell03, attribute: .right, multiplier: 1, constant: 0)
        let lc022 = NSLayoutConstraint(item: cell05, attribute: .top, relatedBy: .equal, toItem: self.baseLineViews[1], attribute: .bottom, multiplier: 1, constant: 0)
        ...
        self.marginRightBottomContraints += [lc03,lc07,lc11,lc12,lc031,lc032,lc042]
