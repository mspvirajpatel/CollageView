...
open class CollageTransition: NSObject {
...
extension CollageTransition: UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if transitionMode == .present {
            ...
            let fromViewController = transitionContext.viewController(forKey: .from) as? PickerViewController
            ...
            let toViewController = transitionContext.viewController(forKey: .to) as? PickerViewController
            fromViewController?.beginAppearanceTransition(false, animated: true)
            toViewController?.beginAppearanceTransition(true, animated: true)
...
private extension CollageTransition {
